...
- Análisis IA de evidencia (Gemini 3.1 Flash-Lite · `analyze-evidence`) con descripción textual de figuras
- Sugerencias automáticas y pendientes tras cada análisis
- Generación de material de refuerzo con Gemini 3.1 Flash-Lite + descarga PDF (`generate-material`)
